    ...
    <SidebarProvider>
      <Sidebar>
        <SidebarHeader className="p-4">
          <Link href="/kol-portal/dashboard" className="flex items-center gap-2 font-semibold">
            <Crown className="h-7 w-7 text-primary" />
            <span className="duration-200 group-data-[collapsible=icon]:hidden">Vigo KOL</span>
          </Link>
        </SidebarHeader>
        <SidebarContent>
          <SidebarMenu>
